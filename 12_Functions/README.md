...
:exclamation: A Function is much the same as a Procedure or a Subroutine, in other programming languages.
____________________________________________________________________________________________________________________________
...
Example: Accessing a function without () will return the function definition:
...
:exclamation: You will learn a lot more about functions later in this tutorial.
____________________________________________________________________________________________________________________________
